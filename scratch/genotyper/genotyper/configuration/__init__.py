...
#     # ),
#     ConfigElement(
#         "labware_calibration_offsets_dir",
#         "API Calibration Offsets Directory",
#         Path("labware") / "offsets",
#         ConfigElementType.DIR,
#         "The location where labware calibration is stored",
#     ),
#     ConfigElement(
#         "labware_user_definitions",
#         "API Custom Labware Directory",
#         Path("labware") / "custom_definitions",
#         ConfigElementType.DIR,
#         "The location where labware definitions are stored",
#     ),
#     ConfigElement(
#         "feature_flags_file",
#         "Feature Flags",
...
#     """
#     if "GERO_API_CONFIG_DIR" in os.environ:
#         return Path(os.environ["GERO_API_CONFIG_DIR"])
#     elif IS_ROBOT:
#         return Path("/data")
#     else:
#         search = (Path.cwd(), Path.home() / ".gero")
#         for path in search:
...
#     """
#     return {
#         ce.name: os.environ["GERO_API_" + ce.name.upper()]
#         for ce in CONFIG_ELEMENTS
#         if "GERO_API_" + ce.name.upper() in os.environ
#     }
#
#
...
#
#
# def get_gero_path(path_name: str) -> Path:
...
#     return get_gero_path("tip_length_calibration_dir")
#
#
# def get_custom_tiprack_def_path() -> Path:
#     return get_gero_path("custom_tiprack_dir")
